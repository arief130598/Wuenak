package com.arief.wuenak.ultility
...
import kotlinx.android.synthetic.main.utility_progress_bar.view.*

class ProgressBarUtility {
    ...
    fun show(context: Context, title:CharSequence?): Dialog {
        ...
        val view = inflator.inflate(R.layout.utility_progress_bar, null)
        if (title != null) {
